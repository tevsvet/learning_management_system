...
public class ScheduleController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Schedule successfully received",
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Schedule for group successfully received",
                    content = @Content(schema = @Schema(implementation = PageResponse.class))
            ),
            @ApiResponse(
                    responseCode = "404",
    ...
    public PageResponse<ScheduleResponse> getAllByGroup(
            @Parameter(description = "Group ID", example = "1")
            @PathVariable Long groupId,

            Pageable pageable) {

        return scheduleService.getAllByGroup(groupId, pageable);
    }
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Schedule for teacher successfully received",
                    content = @Content(schema = @Schema(implementation = PageResponse.class))
            ),
            @ApiResponse(
                    responseCode = "404",
    ...
    public PageResponse<ScheduleResponse> getAllByTeacher(
            @Parameter(description = "Teacher ID", example = "1")
            @PathVariable Long teacherId,

            Pageable pageable) {

        return scheduleService.getAllByTeacher(teacherId, pageable);
    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "404",
                    description = "No group, course or teacher found",
                    content = @Content(schema = @Schema(implementation = ApiError.class))
            ),
            @ApiResponse(
                    responseCode = "409",
